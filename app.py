...
# ---------------- ASSET MAPPING (URL SUPPORT) ----------------
# Moving large files (mp3, ogg, mp4) to Cloudinary/Google Drive makes the app faster.
# If a URL is present here, the app will use it. Otherwise, it falls back to local files.
MEDIA_ASSETS = {
    # BACKGROUND MUSIC
    "love_song_url": "https://drive.google.com/uc?export=download&id=14LvhcWUplPZZ74scQlPeqgP8e3WeAkfD",
    "rose_song_url": "https://drive.google.com/uc?export=download&id=129ZQnGB5AdWUo2AkRdc7e0gtgDgOD5Ez", 
    "propose_song_url": "https://drive.google.com/uc?export=download&id=1UMmItjZTsNyceFJgzeZwl7wz1wym5asa",
    "chocolate_song_url": "https://drive.google.com/uc?export=download&id=17TWpU9pVQpVDizebCS3pSlSviojD6RHr",
    "teddy_song_url": "https://drive.google.com/uc?export=download&id=15ZUwwjkwVRjsLuu3tRPT45rpdLNGcGkf",
    "promise_song_url": "https://drive.google.com/uc?export=download&id=1aLzWMRlTs_ZfBHuAv7yksORBZmIPMfrj",
    "hug_song_url": "https://drive.google.com/uc?export=download&id=1Aj4otl1ncX5ckXd392pM2eIy4pTVXi9y",
    "kiss_song_url": "https://drive.google.com/uc?export=download&id=1lqLtS_SgvAyDbn07h2ozW6u6uYDVvNZ8",
    "valentine_song_url": "https://drive.google.com/uc?export=download&id=13RUCUzw5sk5tu5rFOfUJkGwj3yBlVLK0",
    
    # VIDEOS
    "celebration_video_url": "https://drive.google.com/uc?export=download&id=1tE_3ew3fTIQqv5p3_Li32DOCp0fn82Qv",

    # VOICE NOTES
    "rose_note_url": "https://drive.google.com/uc?export=download&id=1Dndq1d7twx5bpOdvqKYMJScicwEmbAaD",
    "propose_note_url": "https://drive.google.com/uc?export=download&id=1_5t83yJCF1J-7al972PFR_O6OSk-Nf3W",
    "chocolate_note_url": "https://drive.google.com/uc?export=download&id=1O3-TkkfZ5hzO-zJLo6861K4Tzg3S0e4A",
    "teddy_note_url": "https://drive.google.com/uc?export=download&id=16te-SMHrTU0gm0vRHgyIaD_Hy_mYvgzn",
    "promise_note_url": "https://drive.google.com/uc?export=download&id=1-coc18gBwGHFv1RZqIbMAzmDYGNGqk5D",
    "hug_note_url": "https://drive.google.com/uc?export=download&id=1kNhUgXAV6L-SDSbHz3qERAaIZQPfI3kU",
    "kiss_note_url": "https://drive.google.com/uc?export=download&id=1ss1CG5yCJbiaXr5U3f45q0OoaFtpdMcx",
    "valentine_note_url": "https://drive.google.com/uc?export=download&id=1MxQKzkTm4kHzDV9EORJd835T8ateMbuQ",

    # IMAGES
    "photo1_url": "https://drive.google.com/uc?export=download&id=1llNEGIoFY0AkgB5Nb2U9yI7eSs2bZngS",
    "photo2_url": "https://drive.google.com/uc?export=download&id=1wd0R_k86vSqQfqOe85N6xfPJ5T2qFs3w",
    "photo3_url": "https://drive.google.com/uc?export=download&id=1or8Bx9XolKq6GwTAvC2tzQIfNZaiAGPP",

    "teddy_brown_bow_url": "https://drive.google.com/uc?export=download&id=1OrYdyY-SCg5fTgGrWeAKqO1bsfEi0BUM",
    "teddy_brown_shades_url": "https://drive.google.com/uc?export=download&id=1R8SfLy7MBsitbIGRwG7rkYFtuecXPMJH",
    "teddy_brown_letter_url": "https://drive.google.com/uc?export=download&id=1tjjg806QtkTsLzIt5cjg4icd_lw3kX8e",
    "teddy_white_bow_url": "https://drive.google.com/uc?export=download&id=1pdBMc5YBn1McBP9ZRwXRZpCIj2pd6XE4",
    "teddy_white_shades_url": "https://drive.google.com/uc?export=download&id=1VBLJRb1rT2-kxb6IY9jnijxwEKBtTYRU",
    "teddy_white_letter_url": "https://drive.google.com/uc?export=download&id=1CP1HW0YYfN06ANdqx-H6uyKKaAs5UYi4",
    "teddy_panda_bow_url": "https://drive.google.com/uc?export=download&id=17UlBX87Zgr80y988MsMhpDjTNV2bmOH4",
    "teddy_panda_shades_url": "https://drive.google.com/uc?export=download&id=1GKZfFU42aiOY6cGC_GwkDwcu5qGdaPrZ",
    "teddy_panda_letter_url": "https://drive.google.com/uc?export=download&id=1SlXVGf7G4ZsuwDlwpX56Gqaf2r0dOVb5",
}
...
def render_voice_note(day_key):
    ...
    candidates = [
        ...
        (f"{day_key}_note.aac", "audio/mp4"), 
        (f"{day_key}_note.m4a", "audio/mp4"),
        (f"{day_key}_note.wav", "audio/wav"),
        (f"{day_key}_note.aac.converted.mp3", "audio/mp3"),
        (f"{day_key}_note.m4a.converted.mp3", "audio/mp3"),
        (f"{day_key}_note.mp3.converted.mp3", "audio/mp3"),
        (f"{day_key}_note.wav.converted.mp3", "audio/mp3")
    ]
...
def page_teddy():
    ...
    if not st.session_state.bear_created:
        ...
        img_key = bear_map.get((st.session_state.bear_color, st.session_state.bear_accessory))
        selected_img_url = MEDIA_ASSETS.get(f"{img_key.replace('.png', '')}_url") if img_key else None
        ...
        if selected_img_url and selected_img_url.startswith("http"):
            ...
            <p style='text-align:center'>(Selected Bear Delivered!)</p>
            """, unsafe_allow_html=True)
